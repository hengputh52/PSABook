// Genre constants for consistent use across the application
...
// Export just the values for backend enum validation
export const GENRE_VALUES = BOOK_GENRES.map(genre => genre.value);
